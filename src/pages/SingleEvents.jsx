    ...
    <div class="media-wrap flex items-center justify-center mt-4">
        ...
        <div class="event-content Thanksgiving Service">
           ...
           Below are the program details:
            ...
            <ul class="event-meta">
                <li><strong>Date</strong> Sunday, December 15, 2024.</li>
                <li><strong>Time</strong>8:00 AM — 10:30 AM</li>
                <li><strong>Location</strong>All TLBC Int'l church expressions</li>
            </ul>
        </div> 
        ...
        <div class="event-content Parah">
           ...
           Below are the program details:
            ...
            <ul class="event-meta">
                <li><strong>Date</strong> Friday, December 20, 2024.</li>
        ...
        <div class="event-content New Year's Eve ">
            ...
            <p>
            Ministry-wide New Year's Eve Service for the year 2024.
            </p>
           ...
           Below are the program details:
            ...
            <ul class="event-meta">
                <li><strong>Date</strong> Tuesday, December 31st, 2024.</li>
